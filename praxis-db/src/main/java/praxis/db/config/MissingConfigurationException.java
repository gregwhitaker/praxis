...
public class MissingConfigurationException extends IllegalArgumentException {
    ...
    public MissingConfigurationException(String configOption, String environment) {
        super(String.format("Missing configuration option in environment. Please configure be restarting the migration. [config: '%s', environment: '%s'", configOption, environment));
